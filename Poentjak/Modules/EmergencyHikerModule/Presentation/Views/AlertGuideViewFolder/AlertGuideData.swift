...
struct AlertGuideData{
    ...
    static var data: [String: [Int: AlertGuideContentDataModel]] = [
        ...
        "WARM": [
            ...
            3: AlertGuideContentDataModel(image: "AlertGuideData/hipoAlertGuide3", title: "Raise Heat", content: "Slowly warm them up with your body heat, warm drinks (if they’re awake), or heat packs, just go gentle, no sudden heat!"),
            4: AlertGuideContentDataModel(image: "AlertGuideData/hipoAlertGuide4", title: "Move to Safety", content: "Get them to a warm, safe spot as soon as you can to keep them protected from the cold. If symptoms get worse, alert our rangers!")
        ],
        
        "CARE": [
            1: AlertGuideContentDataModel(image: "AlertGuideData/injuryAlertGuide1", title: "Calm Down", content: "Stay calm, take deep breaths, and help the injured person relax. Panic won’t help, keeping a cool head will."),
            2: AlertGuideContentDataModel(image: "AlertGuideData/injuryAlertGuide2", title: "Assess the Injury", content: "Check what’s wrong, is it a twisted ankle, a cut from the fall, or are they unable to move? Prioritize the most urgent issue (like bleeding)."),
            3: AlertGuideContentDataModel(images: ["AlertGuideData/injuryAlertGuide3", "AlertGuideData/injuryAlertGuide4", "AlertGuideData/injuryAlertGuide5"], title: "Respond", content: "For a twisted ankle, stabilize it with a bandage or support. If they're bleeding, apply pressure to stop it. If they can't move, make sure they’re comfortable and avoid moving them further."),
            4: AlertGuideContentDataModel(image: "AlertGuideData/injuryAlertGuide6", title: "Evaluate the Situation", content: "Decide if you can treat the injury on-site, if you need to call the rangers or get them to a safer location for medical attention.")
        ]
