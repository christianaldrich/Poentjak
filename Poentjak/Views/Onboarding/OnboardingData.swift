...
struct OnboardingData: Hashable, Identifiable {
    ...
    static let list: [OnboardingData] = [
        ...
        OnboardingData(id: 1, backgroundImage: "Onboarding/onboarding2", primaryText: "Assistance specific\nto your type of emergency", secondaryText: "Hikewise offers tailored assistance based on your situation. Whether you're dealing with hypothermia, feeling lost, or an injury."),
        ...
        OnboardingData(id: 4, backgroundImage: "Onboarding/onboarding5", primaryText: "Partnering with local rangers", secondaryText: "The rangers on your track use Hikewise! If the situation escalates, don’t be scared to send the SOS to alert the nearby rangers.")
    ]
}
